...
function init()
  ...
  message.setHandler("playerTileBroken", function(_, _, position, layer, materialId, dungeonId)
      ...
      if dungeonId == 65535 or dungeonId == 65533 then
        local biomeBlocks = world.biomeBlocksAt(position)
        if biomeBlocks and contains(biomeBlocks, materialId) then
