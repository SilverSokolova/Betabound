function sb_techType() root.sb_techType = root.techType root.techType = function(t) return root.techConfig(t).sb_effect and "Suit" or root.sb_techType(t) end end
function sb_assetmissing(asset,fallbackAsset) return (root.nonEmptyRegion(asset)~=nil) and asset or fallbackAsset end
